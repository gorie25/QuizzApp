    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('Categories',
              style:
                  TextStyle(color: Colors.white)), // Thay đổi màu chữ nếu cần
          leading: IconButton(
            icon: const Icon(Icons.arrow_back,
                color: Colors.white), // Đổi màu icon nếu cần
            onPressed: () {
                        ...
                        return Padding(
                            ...
                            child: GridView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return InkWell(
                                    // Các ô trong gridview
                                    onTap: () {
                                      //đến bản Article và truyền dữ liệu
                                      context.pushNamed(
                                        RoutersName.articleName,
                                        extra: {
                                          'id': data[index].id,
